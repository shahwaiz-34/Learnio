...
const PIE_COLORS = ["#4f46e5", "#38bdf8"]; 
const BAR_COLORS = ["#4f46e5", "#8b5cf6", "#0ea5e9", "#10b981"]; 

// --- Reusable Stat Card Component ---
const StatCard = ({ title, value, subtitle, icon: Icon, trend, iconColor, iconBg }: StatCardProps) => (
          ...
          <div className="flex-1 min-h-[300px] w-full">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={revenueData} margin={{ top: 5, right: 20, bottom: 5, left: 0 }}>
                ...
                <Tooltip contentStyle={{ borderRadius: '12px', border: 'none', boxShadow: '0 4px 6px -1px rgb(0 0 0 / 0.1)' }} itemStyle={{ color: '#4f46e5', fontWeight: 600 }} />
