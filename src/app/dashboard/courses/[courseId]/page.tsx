...
const MOCK_COURSE = {
  ...
  description: "Master conversational Spanish through immersive audio lessons, real-world scenario practice, and interactive dialogue exercises designed for beginner to intermediate learners.",
  price: 29.99,
  studentsCount: 120,
  revenue: 3600,
  ...
  status: "Published",
  thumbnail: "https://images.unsplash.com/photo-1546410531-bb4caa6b424d?auto=format&fit=crop&q=80&w=1000",
  category: "Languages",
};
...
const MOCK_PURCHASES = [
  { id: "p1", student: "Sarah Jenkins", email: "sarah.j@example.com", date: "2 hours ago", amount: "$29.99" },
  { id: "p2", student: "Michael Chang", email: "m.chang@example.com", date: "5 hours ago", amount: "$29.99" },
  { id: "p3", student: "Emma Watson", email: "e.watson@example.com", date: "Yesterday", amount: "$29.99" },
  { id: "p4", student: "David Miller", email: "david.m@example.com", date: "2 days ago", amount: "$29.99" },
];

const MOCK_STUDENTS = [
  { id: "s1", name: "Sarah Jenkins", email: "sarah.j@example.com", joined: "Aug 02, 2026", progress: 15 },
  { id: "s2", name: "Michael Chang", email: "m.chang@example.com", joined: "Aug 02, 2026", progress: 0 },
  { id: "s3", name: "Emma Watson", email: "e.watson@example.com", joined: "Aug 01, 2026", progress: 68 },
  { id: "s4", name: "David Miller", email: "david.m@example.com", joined: "Jul 31, 2026", progress: 100 },
  { id: "s5", name: "Alex Rivera", email: "a.rivera@example.com", joined: "Jul 29, 2026", progress: 42 },
];
    ...
    <div className="space-y-8 pb-12 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-gray-200 pb-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <h1 className="text-2xl font-bold text-[#0a0a0b] tracking-tight mt-0.5">Course Overview</h1>
          </div>
        </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div>
              <span className="text-xs font-medium text-blue-600 uppercase tracking-wider">{MOCK_COURSE.category}</span>
              <h2 className="text-2xl font-bold text-[#0a0a0b] mt-1">{MOCK_COURSE.title}</h2>
              <p className="text-sm text-gray-600 mt-2 leading-relaxed">{MOCK_COURSE.description}</p>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 pt-2">
              <div className="p-3.5 bg-gray-50 rounded-xl border border-gray-100">
                ...
                <p className="text-xl font-bold text-[#0a0a0b] mt-0.5">${MOCK_COURSE.price}</p>
              </div>
              ...
              <div className="p-3.5 bg-gray-50 rounded-xl border border-gray-100">
                ...
                <p className="text-xl font-bold text-[#0a0a0b] mt-0.5">{MOCK_COURSE.studentsCount}</p>
              </div>
              ...
              <div className="p-3.5 bg-gray-50 rounded-xl border border-gray-100">
                ...
                <p className="text-xl font-bold text-green-600 mt-0.5">${MOCK_COURSE.revenue.toLocaleString()}</p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-6 pt-2 border-t border-gray-100 text-xs text-gray-500">
              <div className="flex items-center gap-1.5">
                ...
                <span>Created: <strong>{MOCK_COURSE.createdDate}</strong></span>
              </div>
              <div className="flex items-center gap-1.5">
                <Clock className="w-4 h-4 text-gray-400" />
                <span>Last Updated: <strong>{MOCK_COURSE.lastUpdated}</strong></span>
              </div>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm lg:col-span-8 flex flex-col">
          <div className="flex justify-between items-center mb-6">
            <div>
              <h3 className="text-base font-semibold text-[#0a0a0b]">Revenue History</h3>
              <p className="text-xs text-gray-500">Monthly earnings generated by this course</p>
            </div>
          ...
          <div className="flex-1 min-h-[260px] w-full">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={revenueTrendData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                ...
                <Area type="monotone" dataKey="revenue" stroke="#0a0a0b" strokeWidth={2.5} fillOpacity={1} fill="url(#courseRevenue)" />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm lg:col-span-4 flex flex-col">
          ...
          <div className="space-y-4 flex-1">
            {MOCK_PURCHASES.map((p) => (
              <div key={p.id} className="flex items-center justify-between p-3 rounded-xl bg-gray-50/80 border border-gray-100">
                <div>
                  <p className="text-sm font-medium text-[#0a0a0b]">{p.student}</p>
      ...
      <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h3 className="text-base font-semibold text-[#0a0a0b]">Enrolled Students</h3>
            <p className="text-xs text-gray-500">Students actively taking this course</p>
          </div>
              ...
              {filteredStudents.length > 0 ? (
                filteredStudents.map((s) => (
                  <tr key={s.id} className="hover:bg-gray-50/50 transition-colors">
                    ...
                    <td className="py-3 px-4 text-gray-600 text-xs">{s.joined}</td>
                    <td className="py-3 px-4">
                      <div className="flex items-center gap-2">
