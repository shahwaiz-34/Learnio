...
const StatCard = ({
  ...
  <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-200 flex flex-col justify-between group">
    ...
    <div>
      ...
      <p
        className={`text-sm mt-1.5 font-medium ${trend === "up" ? "text-emerald-600" : "text-gray-500"}`}
      >
        {subtitle}
      </p>
    </div>
    ...
    <div className="space-y-8 pb-8 bg-gray-50/50 min-h-screen p-4 sm:p-6 lg:p-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Track your course sales, revenue, and student growth.
          </p>
        </div>
        <div className="flex flex-wrap items-center gap-3">
          ...
          <Link
            ...
            className="hidden lg:flex items-center gap-2 px-4 py-2.5 text-sm font-medium bg-white border border-gray-200 text-gray-700 rounded-xl hover:bg-gray-50 hover:text-gray-900 transition-all shadow-sm active:scale-95"
          >
            <Users size={16} /> Students
          </Link>
          <Link
            href="/dashboard/analytics"
            className="flex items-center gap-2 px-4 py-2.5 text-sm font-medium bg-indigo-600 text-white rounded-xl hover:bg-indigo-700 transition-all shadow-sm shadow-indigo-200 active:scale-95"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        <StatCard
          title="Total Courses"
          value="12"
          subtitle="3 Published currently"
          icon={BookOpen}
          trend="neutral"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        <StatCard
          title="Average Order"
          value="$43.80"
          subtitle="Stable across courses"
          icon={Receipt}
          trend="neutral"
        ...
        <StatCard
          ...
          value="8.6%"
          subtitle="Based on unique visits"
          icon={TrendingUp}
          trend="neutral"
            ...
            {[
              ...
              >
                <div className="flex items-center gap-4">
                  <div
                    className={`w-11 h-11 rounded-full flex items-center justify-center font-bold text-sm ${item.color}`}
                  >
                    {item.initials}
                  </div>
                  <div>
            ...
            {[
              {
                ...
                desc: "UI/UX Fundamentals is now live",
                icon: BookOpen,
                time: "Today, 10:23 AM",
              ...
              },
              {
                ...
                desc: "12 new students joined this week",
                icon: Users,
                time: "Aug 1, 2026",
